import type { EntityMetadata, NotificationVariables as NotificationVariables_ } from '@cord-sdk/types';
/**
...
export type NotificationReplyAction = 'create-thread' | 'mention' | 'assign-task' | 'unassign-task' | 'attach-file';
