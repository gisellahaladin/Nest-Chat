...
export interface CreateMessageVariables extends Pick<MessageVariables, 'authorID' | 'id' | 'content'>, Partial<Omit<MessageVariables, 'authorID' | 'id' | 'content' | 'organizationID' | 'threadID'>> {
    /**
...
export interface UpdateMessageVariables extends Partial<Omit<CreateMessageVariables, 'createThread'>> {
    /**
